...
namespace Endless2DTerrain
{
    public class TerrainPiece
    {
        ...
        private void ParentMeshesToTerrainObject()
        {
            ...
            TerrainObject.transform.localScale = new Vector3(TerrainObject.transform.localScale.x, TerrainObject.transform.localScale.y, TerrainObject.transform.localScale.z * 10);
        }
